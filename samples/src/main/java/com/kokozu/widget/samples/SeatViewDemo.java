 ...
 * @since 2017-04-24
 */
public class SeatViewDemo extends AppCompatActivity implements OnChooseSeatListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.seat_view_demo);
        seatView = (SeatView) findViewById(R.id.seat_view);
        thumbnailView = (SeatThumbnailView) findViewById(R.id.thumbnail_view);
            ...
            new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (seats == null || seats.size() == 0) {
                        Toast.makeText(SeatViewDemo.this, "未获取到推荐座位", Toast.LENGTH_SHORT).show();
                    }
                }
            };
    ...
    private View.OnClickListener mRegularClicked =
            new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Toast.makeText(SeatViewDemo.this, message, Toast.LENGTH_SHORT).show();
                }
            };
